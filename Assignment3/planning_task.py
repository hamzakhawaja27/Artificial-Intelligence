...
class Action:
    ...
    def applicable(self, state):
        ...
        @return True if action is applicable in state,
                False otherwise
        """
        return state.issuperset(self.preconditions) 
    ...
    def apply(self, state):
        ...
        @return A new state (set of facts) after the application of the
                action
        """
        new_state=state.union(self.add_effects)
        new_state=new_state.difference(self.del_effects)
...
class Task:
    ...
    def goal_reached(self, state):
        ...
        """
        return state.issuperset(self.goals)
